...
def detectPlatesInScene(imgOriginalScene):
    ...
    print("  listOfPossibleCharsInScene=", listOfPossibleCharsInScene)
    ...
    print(" listOfListsOfMatchingCharsInScene=",  listOfListsOfMatchingCharsInScene)
